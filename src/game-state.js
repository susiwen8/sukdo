import { cloneBoard, generatePuzzle } from './sudoku.js';
...
export function togglePrefillMode(state) {
  return {
    ...state,
    notesMode: false,
...
export function locateFirstWrongPrefill(state) {
...
export function tickClock(state, seconds = 1) {
  if (state.completed) {
    return state;
  }
